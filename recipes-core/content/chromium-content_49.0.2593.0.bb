...
CXXFLAGS_append = " -I${STAGING_INCDIR}/chromium -I${STAGING_INCDIR}/chromium/mojo -I${STAGING_INCDIR}/chromium/skia -I${STAGING_INCDIR}/chromium/ui -I${STAGING_INCDIR}/chromium/cc -I${STAGING_INCDIR}/chromium/skia/config -I${STAGING_INCDIR}/chromium/third_party/skia/include/core -I${STAGING_INCDIR}/chromium/third_party/skia/include/utils -I${STAGING_INCDIR}/chromium/third_party/skia/include/gpu -I${STAGING_INCDIR}/chromium/third_party/khronos -I${STAGING_INCDIR}/chromium/third_party/WebKit -I${STAGING_INCDIR}/chromium/third_party/leveldatabase/src -I${STAGING_INCDIR}/chromium/third_party/leveldatabase/src/include -I${STAGING_INCDIR}/chromium/third_party/angle/src -I${STAGING_INCDIR}/chromium/third_party/mesa/src/include -I${STAGING_INCDIR}/chromium/v8/include -I${STAGING_INCDIR}/chromium/third_party/libyuv/include"
