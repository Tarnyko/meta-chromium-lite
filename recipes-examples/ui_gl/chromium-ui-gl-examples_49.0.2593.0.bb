SUMMARY = "Chromium UI GL examples"
DESCRIPTION = "Some examples files for the Chromium UI GL helper library."
...
DEPENDS = "chromium-ui-gl"

SRC_URI = " \
           file://LICENSE \
           file://CMakeLists.txt \
           file://chromium_ui_gl-1_gpu_timing.cc \
          "
...
EXTRA_OECMAKE_append = " -DLINK_LIBRARIES='-L${STAGING_LIBDIR}/chromium -lui_gl -lbase'"
