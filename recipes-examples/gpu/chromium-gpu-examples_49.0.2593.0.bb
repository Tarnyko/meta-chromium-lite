SUMMARY = "Chromium GPU examples"
DESCRIPTION = "Some examples files for the Chromium GPU library."
...
DEPENDS = "chromium-gpu"

SRC_URI = " \
           file://LICENSE \
           file://CMakeLists.txt \
           file://chromium_gpu-2_shader_manager.cc \
          "
...
EXTRA_OECMAKE_append = " -DLINK_LIBRARIES='-L${STAGING_LIBDIR}/chromium -lgpu -lui_gl -lbase'"
