SUMMARY = "Chromium UI Events examples"
DESCRIPTION = "Some examples files for the Chromium UI Events helper library."
...
DEPENDS = "chromium-ui-events"

SRC_URI = " \
           file://LICENSE \
           file://CMakeLists.txt \
           file://chromium_ui_events-1_mouse.cc \
          "
...
EXTRA_OECMAKE_append = " -DLINK_LIBRARIES='-L${STAGING_LIBDIR}/chromium -lui_events -lbase'"
